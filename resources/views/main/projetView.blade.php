...
<div id="projet"  >
    ...
    <input type="hidden" id="projectId" value={{$id}} >
      <div class="btn-group mb-3">
        <button v-on:click="printDoc" class="btn btn-lg btn-primary btn-save">Print</button>
        <button v-on:click="save" class="btn btn-lg btn-primary btn-save">Save</button>
        <button v-on:click="pdf" class="btn btn-lg btn-primary btn-save">PDF</button>
      </div>   

    <div class="row">
	<div contenteditable="true" id="docContent" class="ml-4">
        ...
        <div class="rightBar" >
          <table id="dataTable">
                  ...
                  <tbody>
                        <tr v-for="m in modeles" v-on:click="getContent(m.id)" ><td>@{{m.nom}}</td></tr>
                  </tbody>
            </table>
    ...
    <!-- document submit -->
        ...
        <form id="saveDoc" class="row form-horizontal hidden" method="POST" action="/pdf" >
            @csrf
    ...
    var vm = new Vue({
          ...
          methods:{
            ...
            pdf(){
                  ...
                  // window.location.href = "/pdf/"+this.pdfId;
                  // this.$http.get('/pdf/'+this.pdfId).then( (data) => 
                  //                { 
                  //                      console.log(this.content);
